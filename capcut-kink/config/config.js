...
export const CONFIG = {
  ...
  CAPCUT: {
    ...
    SELECTORS: {
      ...
      // Birthday UI
    BIRTHDAY_INPUT: 'input.gate_birthday-picker-input', // Selector class murni
    ...
    BIRTHDAY_NEXT_BUTTON: '.lv_sign_in_panel_wide-primary-button', // Tombol biru aktif
  ...
  // Birthday Configuration (Bahasa Indonesia sesuai UI)
  BIRTHDAY: {
    MONTHS: [
